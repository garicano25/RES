        ...
        alertMensajeConfirm({
            ...
            await ajaxAwaitFormData({ api: 1, ID_FORMULARIO_INVENTARIO: ID_FORMULARIO_INVENTARIO }, 'InventarioSave', 'formularioINVENTARIO', 'guardarINVENTARIO', { callbackAfter: true, callbackBefore: true }, () => {
                ...
                ID_FORMULARIO_INVENTARIO = data.inventario.ID_FORMULARIO_INVENTARIO
                    ...
                    document.getElementById('formularioINVENTARIO').reset();
                    Tablalistadeasignacion.ajax.reload()
...
var Tablalistadeasignacion = $("#Tablalistadeasignacion").DataTable({
    language: {
   ...
   scrollX: true,
    ...
    ajax: {
        dataType: 'json',
        method: 'GET',
        url: '/Tablalistadeasignacion',
        beforeSend: function () {
            mostrarCarga();
        },
        complete: function () {
            Tablalistadeasignacion.columns.adjust().draw();
            ocultarCarga();
        },
...
drawCallback: function () {
    ...
    const table = document.querySelector('#Tablalistadeasignacion');
...
$('#Tablalistadeasignacion tbody').on('click', 'td>button.EDITAR', function () {
    var tr = $(this).closest('tr');
    var row = Tablalistadeasignacion.row(tr);
...
$(document).ready(function() {
    $('#Tablalistadeasignacion tbody').on('click', 'td>button.VISUALIZAR', function () {
    var tr = $(this).closest('tr');
    var row = Tablalistadeasignacion.row(tr);
...
$('#Tablalistadeasignacion tbody').on('change', 'td>label>input.ELIMINAR', function () {
    var tr = $(this).closest('tr');
    var row = Tablalistadeasignacion.row(tr);
    ...
    eliminarDatoTabla(data, [Tablalistadeasignacion], 'inventarioDelete');
});
