        ...
        alertMensajeConfirm({
            ...
            await ajaxAwaitFormData({ api: 1, ID_FORMULARIO_INVENTARIO: ID_FORMULARIO_INVENTARIO }, 'InventarioSave', 'formularioINVENTARIO', 'guardarINVENTARIO', { callbackAfter: true, callbackBefore: true }, () => {
                ...
                ID_FORMULARIO_INVENTARIO = data.inventario.ID_FORMULARIO_INVENTARIO
                    ...
                    document.getElementById('formularioINVENTARIO').reset();
                    Tablalistadealertas.ajax.reload()
...
var Tablalistadealertas = $("#Tablalistadealertas").DataTable({
    language: {
    ...
    ajax: {
        dataType: 'json',
        method: 'GET',
        url: '/Tablalistadealertas',
        beforeSend: function () {
            mostrarCarga();
        },
        complete: function () {
            Tablalistadealertas.columns.adjust().draw();
            ocultarCarga();
        },
...
drawCallback: function () {
    ...
    const table = document.querySelector('#Tablalistadealertas');
...
$('#Tablalistadealertas tbody').on('click', 'td>button.EDITAR', function () {
    var tr = $(this).closest('tr');
    var row = Tablalistadealertas.row(tr);
...
$(document).ready(function() {
    $('#Tablalistadealertas tbody').on('click', 'td>button.VISUALIZAR', function () {
    var tr = $(this).closest('tr');
    var row = Tablalistadealertas.row(tr);
...
$('#Tablalistadealertas tbody').on('change', 'td>label>input.ELIMINAR', function () {
    var tr = $(this).closest('tr');
    var row = Tablalistadealertas.row(tr);
    ...
    eliminarDatoTabla(data, [Tablalistadealertas], 'inventarioDelete');
});
