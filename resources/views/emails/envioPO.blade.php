...
<body>
    ...
    <div class="container"> 
        <div class="header"> Notificación de Orden de Compra </div> 
        <div class="content">
            <p> Estimado proveedor, </p>
            <p> Se le informa que tiene una <b>orden de compra pendiente</b> en el sistema. </p>
            <div class="info-box"> Detalle de la orden </div>
