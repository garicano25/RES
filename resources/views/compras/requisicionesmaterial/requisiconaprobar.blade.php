...
<div class="contenedor-contenido">
    ...
    <div class="card-body">
        <table id="Tablarequsicionaprobada" class="table table-hover bg-white table-bordered text-center w-100 TableCustom">
                            ...
                            <div class="col-12 mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <label>Fecha *</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control mydatepicker" placeholder="aaaa-mm-dd" id="FECHA_APRUEBA_MR" name="FECHA_APRUEBA_MR"  style="pointer-events:none; background-color:#e9ecef;" required>
                                            <span class="input-group-text"><i class="bi bi-calendar-event"></i></span>
                                        </div>
                                    </div>
                                </div>
