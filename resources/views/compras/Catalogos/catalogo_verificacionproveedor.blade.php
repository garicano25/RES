...
<div class="contenedor-contenido">
    <ol class="breadcrumb mb-5">
        ...
        <button type="button" class="btn btn-light waves-effect waves-light " data-bs-toggle="modal" data-bs-target="#miModal_VERIFICACIONPROVEEDOR" style="margin-left: auto;">
