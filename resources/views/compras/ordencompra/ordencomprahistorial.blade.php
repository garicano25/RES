...
<div class="contenedor-contenido">
    <ol class="breadcrumb mb-5" style="display: flex; justify-content: center; align-items: center;">
        <h3 style="color: #ffffff; margin: 0;">&nbsp;Orden de compra - Historial</h3>
    </ol>
    ...
    <div class="card-body">
        <table id="Tablaordencomprahistorial" class="table table-hover bg-white table-bordered text-center w-100 TableCustom">
        </table>
    </div>
</div>
