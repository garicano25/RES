...
<div class="modal fade" id="miModal_proveedortemporal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" id="formularioPROVEEDORTEMP" style="background-color: #ffffff;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="guardarPROVEEDORTEMP">Guardar</button>
                </div>
            </form>
        </div>
    </div>
