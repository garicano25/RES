...
<body>
    ...
    <table>
        <tr>
            <td class="bg-gray" style="width:20%">Nombre del consultor</td>
            <td>
    ...
    <table>
        <tr>
            <td style="border: 1px solid black; padding:8px; font-size:10px; line-height:14px; text-align: justify;">
                ...
                <br>
                a. Utilizar el elemento durante la prestación de servicio en las áreas cuya obligatoriedad de uso se encuentra señalizado.
                <br>
