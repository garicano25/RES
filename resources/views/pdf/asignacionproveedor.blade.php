...
<body>
    ...
    <div class="contenido">
        ...
        <table style="margin-top: 10px; width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="width: 70%; border: none; border-bottom: 1px solid #000;">
                    {{
                        trim(
                            ($empleado->REPRESENTANTE_LEGAL_ALTA ?? '')
                        )
                    }}
                </td>
            </tr>
        ...
        <div class="texto-legal" style="margin-top: 10px;">
            ...
            consultores de <strong>RES</strong> cuiden el equipo que se le ha asignado y lo utilicen
            ...
            terminación de la relación comercial. Adicionalmente <strong>RES</strong> podrá exigir el
            pago de la reparación o reposición de estos activos. La pérdida, robo o daño de cualquier
            equipo propiedad de <strong>RES</strong> debe de ser reportada a la administración.
        </div>
        ...
        <div class="texto-acuse" style="margin-top: 10px;">
            ...
            <strong>RES</strong> a que se me descuente de mi factura o de cualquier otra forma, este valor.
        </div>
