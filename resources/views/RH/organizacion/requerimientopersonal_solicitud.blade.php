...
<div class="contenedor-contenido">
    ...
    <div class="card-body">
        <table id="Tablasolicitudrequerimientopersonal" class="table table-hover bg-white table-bordered text-center w-100 TableCustom">
                        ...
                        <div id="MOSTRAR_TODO" style="display: block">
                            ...
                            <div class="row mb-3 mt-4">
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control mydatepicker" placeholder="aaaa-mm-dd" id="FECHA_RP" name="FECHA_RP" required style="pointer-events:none; background-color:#e9ecef;">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control " id="NOMBRE_SOLICITA_RP" name="NOMBRE_SOLICITA_RP" placeholder="Nombre del solicitante" value="{{ Auth::user()->EMPLEADO_NOMBRE }} {{ Auth::user()->EMPLEADO_APELLIDOPATERNO }} {{ Auth::user()->EMPLEADO_APELLIDOMATERNO }}" readonly>
                                </div>
                            </div>


                            <div class="mb-3 mt-2" id="DIV_APROBACION" style="display: none;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
