            ...
            <div class="col-12">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN1_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE1_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN2_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE2_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN3_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"  id="INTERNAS_PARAQUE3_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN4_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE4_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN5_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE5_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN6_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE6_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                            ...
                            <td>
                              <input type="text" id="INTERNAS_FRECUENCIA6_ANUAL_DPT" name=[]" class="form-control text-center" style="width: 100%;">
                            </td>
                        </tr>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN8_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE8_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN9_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE9_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_CONQUIEN10_DPT" name="INTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          </td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="INTERNAS_PARAQUE10_DPT" name="INTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                          </td>
                          <td>
              ...
              <div class="col-12">
                  <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN1_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE1_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN2_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE2_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN3_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"  id="EXTERNAS_PARAQUE3_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN4_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE4_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN5_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE5_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN6_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE6_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN7_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE7_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN8_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE8_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN9_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE9_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                        ...
                        <tr>
                          <td>
                            <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_CONQUIEN10_DPT" name="EXTERNAS_CONQUIEN_DPT[]" rows="2"></textarea></td>
                          <td>
                              <textarea class="form-control"  style="width: 100%;"   id="EXTERNAS_PARAQUE10_DPT" name="EXTERNAS_PARAQUE_DPT[]"rows="2"></textarea></td>
                            <td>
                              <input type="text" id="EXTERNAS_FRECUENCIA10_DIARIAS_DPT" name="EXTERNAS_FRECUENCIA_DIARIAS_DPT[]" class="form-control text-center" style="width: 100%;">
                            </td>
                            <td>
                              <input type="text" id="EXTERNAS_FRECUENCIA10_SEMANAL_DPT" name="EXTERNAS_FRECUENCIA_SEMANAL_DPT[]" class="form-control text-center" style="width: 100%;">
                            </td>
                            <td>
                            ...
                            <td>
                              <input type="text" id="EXTERNAS_FRECUENCIA10_SEMESTRAL_DPT" name="EXTERNAS_FRECUENCIA_SEMESTRAL_DPT[]" class="form-control text-center" style="width: 100%;">
                            </td>
                            <td>
