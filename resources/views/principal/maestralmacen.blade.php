...
<body class="body">
    ...
    <script src="/assets/js_sitio/bitacorasalmacen/bitacoraconsumible.js?v=1.32"></script>
    @endif
    ...
    <script src="/assets/js_sitio/bitacorasalmacen/bitacoravehiculo.js?v=1.22"></script>
    @endif
