...
<body class="body">
    ...
    <script src="/assets/js_sitio/inventario/inventario.js?v=1.37"></script>
    @endif
    ...
    <script src="/assets/js_sitio/salidalmacen/salidalmacen.js?v=1.21"></script>
    @endif
    ...
    <script src="/assets/js_sitio/listadeaf/listaaf.js?v=2.0"></script>
    @endif

    @if(request()->is('listadeafn'))
    <script src="/assets/js_sitio/listadeafn/listaafn.js?v=2"></script>
    @endif

    @if(request()->is('listadecomercializacion'))
    <script src="/assets/js_sitio/listacomercializacion/listacomercializacion.js?v=2"></script>
    @endif

    @if(request()->is('listadeitemcriticos'))
    <script src="/assets/js_sitio/listadeitemcritico/listaitemcritico.js?v=2.0"></script>
    @endif

    @if(request()->is('listadealertas'))
    <script src="/assets/js_sitio/listadealerta/listaalerta.js?v=2.0"></script>
    @endif

    @if(request()->is('listadeasignacion'))
    <script src="/assets/js_sitio/listadeasignacion/listadeasignacion.js?v=2.0"></script>
    @endif
