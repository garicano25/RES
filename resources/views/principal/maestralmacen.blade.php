...
<body class="body">
    ...
    <script src="/assets/js_sitio/inventario/inventario.js?v=1.29"></script>
    @endif
    ...
    <script src="/assets/js_sitio/salidalmacen/salidalmacen.js?v=1.20"></script>
    @endif
    ...
    <script src="/assets/js_sitio/bitacorasalmacen/bitacoravehiculo.js?v=1.28"></script>
    @endif
