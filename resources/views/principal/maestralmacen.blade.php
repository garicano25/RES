...
<body class="body">
    ...
    <script src="/assets/js_sitio/bitacorasalmacen/bitacoraconsumible.js?v=1.5"></script>
    @endif


    @if(request()->is('bitacoraretornables'))
    <script src="/assets/js_sitio/bitacorasalmacen/bitacoraretornable.js?v=1.5"></script>
    @endif

    @if(request()->is('bitacoravehiculos'))
    <script src="/assets/js_sitio/bitacorasalmacen/bitacoravehiculo.js?v=1.5"></script>
    @endif
</body>
