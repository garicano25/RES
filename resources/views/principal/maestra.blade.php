...
<body class="body">
    ...
    <script src="/assets/js_sitio/usuario/usuario.js?v=4.9"></script>
    @endif

    @if(request()->is('contratacion'))
    <script src="/assets/js_sitio/contratacion/contratacion.js?v=11.22"></script>
    <!-- Form wizard -->
    ...
    <script src="/assets/js_sitio/RecEmpleados/recursosempleado.js?v=1.15"></script>
    @endif
    ...
    <script src="/assets/js_sitio/RecEmpleados/recempleadoaprobacion.js?v=1.12"></script>
    @endif
