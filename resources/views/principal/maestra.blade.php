...
<body class="body">
    ...
    <script src="/assets/js_sitio/seleccion/seleccion.js?v=22.2"></script>
    @endif
    ...
    <script src="/assets/js_sitio/usuario/usuario.js?v=4.2"></script>
    @endif

    @if(request()->is('Contratación'))
    <script src="/assets/js_sitio/contratacion/contratacion.js?v=11.7"></script>
    <!-- Form wizard -->
