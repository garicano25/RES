...
<body class="body">
    ...
    <script src="/assets/js_sitio/requisiconmaterial/requisiconlider.js?v=2.8"></script>
    @endif


    @if(request()->is('Requisición_materiales_aprobación'))
    <script src="/assets/js_sitio/requisiconmaterial/requisiconaprobada.js?v=2.0"></script>
    @endif


    @if(request()->is('Bitácora'))
    <script src="/assets/js_sitio/requisiconmaterial/bitacora.js?v=1.1"></script>
    @endif
    ...
    @if(request()->is('Lista_proveedores'))
    <script src="/assets/js_sitio/proveedor/listaproveedor.js?v=1.3"></script>
