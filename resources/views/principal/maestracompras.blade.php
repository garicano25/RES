...
<body class="body">
    ...
    <script src="/assets/js_sitio/requisiconmaterial/bitacora.js?v=1.14"></script>
    @endif
    ...
    <script src="/assets/js_sitio/proveedor/proveedorespotenciales.js?v=1.7"></script>
    @endif
    ...
    <script src="/assets/js_sitio/orden_compra/orden_compra.js?v=1.7"></script>
    @endif


    @if(request()->is('Orden_compra_aprobación'))
    <script src="/assets/js_sitio/orden_compra/aprobacioncompra.js?v=1.1"></script>
    @endif
