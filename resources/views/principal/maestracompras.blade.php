...
<body class="body">
    ...
    @if(request()->is('listaproveedores'))
    <script src="/assets/js_sitio/proveedor/listaproveedor.js?v=27"></script>
    ...
    <script src="/assets/js_sitio/requisiciongr/requisiciongr.js?v=11"></script>
    @endif
    ...
    <script src="/assets/js_sitio/requisiciongr/requisiciongrhistorial.js?v=10"></script>
    @endif

    @if(request()->is('listaproveedorescriticos'))
    <script src="/assets/js_sitio/proveedor/listraproveedorcritico.js?v=15"></script>
    <script src="/assets/plugins/form_wizard_steps_bootstrap/form_wizard_script.js"></script>
    @endif
    ...
    <script src="/assets/js_sitio/proveedor/relacionpago.js"></script>
    @endif
