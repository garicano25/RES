...
<div class="contenedor-contenido">
    <ol class="breadcrumb mb-5" style="display: flex; justify-content: center; align-items: center;">
        <h3 style="color: #ffffff; margin: 0;"><i class="bi  bi-patch-check-fill"></i>&nbsp;Aprobar salidas de almacén</h3>

    </ol>

    <div class="card-body">
        <table id="Tablaaprobacionalmacen" class="table table-hover bg-white table-bordered text-center w-100 TableCustom">
                        ...
                        <div class="col-12 mt-3">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <label>Fecha *</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control mydatepicker" placeholder="aaaa-mm-dd" id="FECHA_APRUEBA_SOLICITUD" name="FECHA_APRUEBA_SOLICITUD" name="FECHA_SOLICITUD_MR" style="pointer-events:none; background-color:#e9ecef;" required>
                                        <span class="input-group-text"><i class="bi bi-calendar-event"></i></span>
                                    </div>
                                </div>
                            </div>
