...
<style>
    ...
    #Tablainventarioinactivo td.col-justificacion {
...
<div class="contenedor-contenido">
    <ol class="breadcrumb mb-5 d-flex justify-content-between align-items-center" style="background:#a7d46f; border-radius:10px; padding:10px;">
        ...
        <h3 class="mb-0 text-white">
            <i class="bi bi-card-list me-2"></i> Inventario inactivo
        </h3>
        ...
        <div class="tabla-scroll-wrapper">
            ...
            <div class="tabla-scroll-bottom">
                <div class="table-responsive">
                    <table id="Tablainventarioinactivo" class="table table-hover table-bordered  w-100" style="min-width: 1000px; table-layout: fixed;">
