...
namespace App\Http\Controllers\listainfraestructura;
...
class listainfraestructuraController extends Controller
{
    public function index()
    {
        ...
        return view('almacen.listainfraestructura.listainfraestructura', compact('tipoinventario', 'proveedoresOficiales', 'proveedoresTemporales'));
    }


    public function Tablalistainfraestructura()
    {
        try {

            $tabla = inventarioModel::where('ES_INFRAESTRUCTURA', 1)->get();
